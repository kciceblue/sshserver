...
all 61 current parser signals in 23 files to one or more executable owners.
The targets cover:
...
All 18 targets have a checked-in minimized invalid seed under their package's
