...
case "$kernel/$machine" in
  Linux/x86_64|Linux/amd64)
    target=linux/amd64
    artifact_url='https://kciceblue.github.io/sshserver/releases/v0.1.1/sshserver-linux-amd64'
    artifact_bytes=17835514
    artifact_sha256='24339f58e5a5c003f2d0c21ca577fa870cae566ff87a3282ed18060fb67268cc'
    ;;
  Linux/aarch64|Linux/arm64)
    target=linux/arm64
    artifact_url='https://kciceblue.github.io/sshserver/releases/v0.1.1/sshserver-linux-arm64'
    artifact_bytes=16841320
    artifact_sha256='8bb08aca1010c82e21d81c72f0d147761d277853676f7954496f375c068a1ceb'
    ;;
  Darwin/x86_64|Darwin/amd64)
    target=darwin/amd64
    artifact_url='https://kciceblue.github.io/sshserver/releases/v0.1.1/sshserver-darwin-amd64'
    artifact_bytes=17828272
    artifact_sha256='55b76591e779d02becfac2f2d28fdc25d1e742a2e97d416e485fe107346b2510'
    ;;
  Darwin/arm64|Darwin/aarch64)
    target=darwin/arm64
    artifact_url='https://kciceblue.github.io/sshserver/releases/v0.1.1/sshserver-darwin-arm64'
    artifact_bytes=17182722
    artifact_sha256='f0aec9ff440d7bcdeaa5bb6a851feac7ba1f14828c34b5077ce230ce45f3543f'
    ;;
...
download_exact 'https://kciceblue.github.io/sshserver/releases/v0.1.1/release-manifest.json' 2180 'd8afaa9a2aba8cd6d00c71bd0df31eaf2cfc42fcb5f9b5d8cec850c228206e8d' ./release-manifest.json 400
download_exact 'https://kciceblue.github.io/sshserver/releases/v0.1.1/LICENSE' 11357 'c71d239df91726fc519c6eb72d318ec65820627232b2f796219e87dcf35d0ab4' ./LICENSE 400
download_exact 'https://kciceblue.github.io/sshserver/releases/v0.1.1/NOTICE' 2175 'd06400efad26daf67b6fa6dd97e8acce6d391070789ea60762f8b9d8c99a29ea' ./NOTICE 400
...
run_clean ./sshserver deploy preview --manifest "$manifest_path" --manifest-sha256 'd8afaa9a2aba8cd6d00c71bd0df31eaf2cfc42fcb5f9b5d8cec850c228206e8d' --artifact "$artifact_path" --license "$license_path" --notice "$notice_path" > ./deployment-preview.json || fail 'verified deployment preview failed'
...
printf '%s\n' "Verified sshserver v0.1.1 deployment preview for $target:" >&4
...
run_clean ./sshserver deploy apply --manifest "$manifest_path" --manifest-sha256 'd8afaa9a2aba8cd6d00c71bd0df31eaf2cfc42fcb5f9b5d8cec850c228206e8d' --artifact "$artifact_path" --license "$license_path" --notice "$notice_path" --confirmed-preview-sha256 "$preview_sha256" --consume-inputs --supervise-foreground || fail 'verified deployment apply or supervised foreground server failed'
